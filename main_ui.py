...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.dwTools.sizePolicy().hasHeightForWidth())
        self.dwTools.setSizePolicy(sizePolicy2)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/toolbar/svgicons/brush.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButtonBrush.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/toolbar/svgicons/Fill.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButtonFill.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/toolbar/svgicons/line.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButtonLine.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/toolbar/svgicons/rectangle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButtonRect.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/toolbar/svgicons/circle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButtonCircle.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/toolbar/svgicons/select-rectangle-gray.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButtonSelectRectangle.setIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/toolbar/svgicons/select-circle-gray.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButtonSelectCircle.setIcon(icon18)
        ...
        icon19 = QIcon()
        icon19.addFile(u":/toolbar/svgicons/magic.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/toolbar/svgicons/rounded-rectangle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon21 = QIcon()
        icon21.addFile(u":/toolbar/svgicons/spray-gray.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButtonSpray.setIcon(icon21)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/toolbar/svgicons/eraser-gray.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButtonEraser.setIcon(icon22)
        ...
        icon23 = QIcon()
        icon23.addFile(u":/toolbar/svgicons/text.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButtonText.setIcon(icon23)
        ...
        icon24 = QIcon()
        icon24.addFile(u":/toolbar/svgicons/eyedropper.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
