...
class Editor(draw_window_ui.Ui_Form, QWidget):
    ...
    # Your custom mouse press event handling code here
        self.pic1_mousePressEvent(event)
    def mouseMoveEvent(self, event):
        # Your custom mouse move event handling code here
        self.pic1_mouseMoveEvent(event)

    def mouseReleaseEvent(self, event):
        # Your custom mouse release event handling code here
        self.pic1_mouseReleaseEvent(event)
    def paintEvent(self, event):
        # Your custom paint event handling code here
        self.pic1_paintEvent(event)

    def wheelEvent(self, event):
        # Your custom wheel event handling code here
        self.pic1_mouseWheelEvent(event)
