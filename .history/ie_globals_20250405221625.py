...
ie_brush = ie_tool("Brush", "svgicons/brush-gray.svg", 1001, "B")
ie_line = ie_tool("Line", "svgicons/line-gray.svg", 1002, "L")
ie_rect = ie_tool("Rectangle", "svgicons/rectangle-gray.svg", 1003, "R")
ie_circle = ie_tool("Circle", "svgicons/circle-gray.svg", 1004, "C")
ie_spray = ie_tool("Spray", "svgicons/spray-gray.svg", 1005, "S")
ie_fill = ie_tool("Fill", "svgicons/fill-gray.svg", 1006, "F")
ie_text = ie_tool("Text", "svgicons/text-gray.svg", 1007, "T")
ie_eraser = ie_tool("Eraser", "svgicons/eraser-gray.svg", 1008, "E")
ie_zoom = ie_tool("Zoom", "svgicons/zoom-gray.svg", 1009, "Z")
ie_pan = ie_tool("Pan", "svgicons/pan-gray.svg", 1010, "P")
ie_dropper = ie_tool("Dropper", "svgicons/dropper-gray.svg", 1011, "D")
ie_rounded_rect = ie_tool("Rounded Rectangle", "svgicons/rounded-rectangle-gray.svg", 1012, "O")
