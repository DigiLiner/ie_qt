...
def draw_pen(img1: QImage, start_pos: QPoint, end_pos: QPoint):
    ...
    transparency = ie_globals.pen_blur *0.001 # Her bir çizginin/noktanın şeffaflığı (0.0 - 1.0)
    ...
    if start_pos == end_pos:
        ...
        radius = ie_globals.current_pen.widthF() / 4.0
    ...
    pen = QPen(color)
    pen.setWidthF(ie_globals.current_pen.widthF()/2)
