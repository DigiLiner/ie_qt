...
from PyQt6.QtGui import QPen, QColor, QBrush, Qt, QImage, QPainter, QMouseEvent, QPixmap
from PyQt6.QtWidgets import QWidget,QApplication, QMainWindow, QGraphicsScene, QSizePolicy, QLabel, QHBoxLayout
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def open_file(self):
        ...
        if filename:
            ...
            doc.picOrg = PyQt6.QtGui.QImage(filename)
            doc.pic1_update()
