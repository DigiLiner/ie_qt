...
#region mouse wheel [rgba(222, 100, 222,0.1)]
    def pic1_mouseWheelEvent(self, event: QtGui.QWheelEvent) -> None:
        ...
        self.pic1_update()
        hbar.setValue((hbar.value() + event_pos.x())*self.zoomFactor/ie_globals.image_width)
        vbar.setValue(vbar.value() + event_pos.y()*self.zoomFactor/ie_globals.image_height)
