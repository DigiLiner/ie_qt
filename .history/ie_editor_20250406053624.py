...
##region mouse wheel [rgba(222, 100, 222,0.1)]
    def picmouseWheelEvent(self, event: QtGui.QWheelEvent) -> None:
        # Get scroll bars
...
#region mouse release [rgba(255, 255, 121,0.1)]
   ...
   #region paint [rgba(125, 152, 200,0.1)]
    ...
    def pic1_update(self) -> None:
        ...
        self.scrollArea.setMinimumHeight(h)
        self.scrollArea.setMaximumWidth(w)
        self.scrollArea.setMaximumHeight(h)
