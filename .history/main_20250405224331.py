...
class FloatWindow(QtWidgets.QMainWindow,float_window_ui):
    ...
    def paintEvent(self,event):
        ...
        painter.setBrush(ie_globals.current_penpen.color())
...
if __name__ == "__main__":
    ...
    app.setStyle("Breeze")
    #app.setPalette(PySide6.QtGui.QPalette(QColor("#555555")))# Dark Mode Linux
