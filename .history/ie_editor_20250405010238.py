...
##region mouse wheel [rgba(222, 100, 222,0.1)]
    def pic1_mouseWheelEvent(self, event: QtGui.QWheelEvent) -> None:
        ...
        # Calculate mouse position relative to the original image space
        ...
        # Calculate new scroll positions to maintain mouse position
        new_scroll_x = int((img_x * new_zoom) - viewport_pos.x())
        new_scroll_y = int((img_y * new_zoom) - viewport_pos.y())
