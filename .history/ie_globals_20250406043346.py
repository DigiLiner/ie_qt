...
ie_tool_pen = ie_tool("Pen", "svgicons/pen-gray.svg", 1000, "P")
ie_tool_brush = ie_tool("Brush", "svgicons/brush.svg", 1001, "B")
ie_tool_line = ie_tool("Line", "svgicons/line-gray.svg", 1002, "L")
ie_tool_rect = ie_tool("Rectangle", "svgicons/rectangle.svg", 1003, "R")
ie_tool_circle = ie_tool("Circle", "svgicons/circle-gray.svg", 1004, "C")
ie_tool_spray = ie_tool("Spray", "svgicons/spray-gray.svg", 1005, "S")
ie_tool_fill = ie_tool("Fill", "svgicons/fill.svg", 1006, "F")
ie_tool_text = ie_tool("Text", "svgicons/text.svg", 1007, "T")
ie_tool_eraser = ie_tool("Eraser", "svgicons/eraser-gray.svg", 1008, "E")
ie_tool_pan = ie_tool("Pan", "svgicons/pan-gray.svg", 1010, "P")
ie_tool_dropper = ie_tool("Dropper", "svgicons/dropper.svg", 1011, "D")
ie_tool_rounded_rect = ie_tool("Rounded Rectangle", "svgicons/rounded-rectangle.svg", 1012, "O")
ie_tool_ellipse = ie_tool("Ellipse", "svgicons/ellipse-gray.svg", 1013, "L")
ie_tool_wand = ie_tool("Wand", "svgicons/wand-gray.svg", 1014, "W")
ie_tool_polygon = ie_tool("Polygon", "svgicons/polygon-gray.svg", 1015, "G")
ie_tool_bezier = ie_tool("Bezier", "svgicons/bezier-gray.svg", 1016, "B")
ie_tool_select_rect = ie_tool("Select Rectangle", "svgicons/select-rectangle.svg", 1017, "S")
ie_tool_select_circle = ie_tool("Select Circle", "svgicons/select-circle.svg", 1018, "S")
ie_tool_select_polygon = ie_tool("Select Polygon", "svgicons/select-polygon.svg", 1019, "S")
ie_tool_select_lasso = ie_tool("Select Lasso", "svgicons/select-lasso.svg", 1020, "S")
ie_tool_select_path = ie_tool("Select Path", "svgicons/select-path.svg", 1021, "S")
ie_tool_crop = ie_tool("Crop", "svgicons/crop.svg", 1022, "C")
