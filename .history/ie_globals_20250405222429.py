...
tools :list = []
pen = ie_tool("Pen", "svgicons/pen-gray.svg", 1000, "P")
brush = ie_tool("Brush", "svgicons/brush.svg", 1001, "B")
line = ie_tool("Line", "svgicons/line-gray.svg", 1002, "L")
rect = ie_tool("Rectangle", "svgicons/rectangle.svg", 1003, "R")
circle = ie_tool("Circle", "svgicons/circle-gray.svg", 1004, "C")
spray = ie_tool("Spray", "svgicons/spray-gray.svg", 1005, "S")
fill = ie_tool("Fill", "svgicons/fill.svg", 1006, "F")
text = ie_tool("Text", "svgicons/text.svg", 1007, "T")
eraser = ie_tool("Eraser", "svgicons/eraser-gray.svg", 1008, "E")
pan = ie_tool("Pan", "svgicons/pan-gray.svg", 1010, "P")
dropper = ie_tool("Dropper", "svgicons/dropper.svg", 1011, "D")
rounded_rect = ie_tool("Rounded Rectangle", "svgicons/rounded-rectangle.svg", 1012, "O")
ellipse = ie_tool("Ellipse", "svgicons/ellipse-gray.svg", 1013, "L")
wand = ie_tool("Wand", "svgicons/wand-gray.svg", 1014, "W")
polygon = ie_tool("Polygon", "svgicons/polygon-gray.svg", 1015, "G")
bezier = tool("Bezier", "svgicons/bezier-gray.svg", 1016, "B")

tools.append(ie_pen)
tools.append(ie_brush)
tools.append(ie_line)
tools.append(ie_rect)
tools.append(ie_circle)
tools.append(ie_spray)
tools.append(ie_fill)
tools.append(ie_text)
tools.append(ie_eraser)
tools.append(ie_pan)
tools.append(ie_dropper)
tools.append(ie_rounded_rect)
tools.append(ie_ellipse)
tools.append(ie_wand)
tools.append(ie_polygon)
tools.append(ie_bezier)
...
current_tool:ie_tool = ie_pen
previous_tool:ie_tool = ie_pen
#color of pencil
