...
##region mouse wheel [rgba(222, 100, 222,0.1)]
    def pic1_mouseWheelEvent(self, event: QtGui.QWheelEvent) -> None:
        ...
        mouse_pos_x = (viewport_pos.x() + hbar.value()) / self.zoomFactor
        mouse_pos_y = (viewport_pos.y() + vbar.value()) / self.zoomFactor
        ...
        new_scroll_x = (mouse_pos_x * new_zoom) - viewport_pos.x()
        new_scroll_y = (mouse_pos_y * new_zoom) - viewport_pos.y()
