...
def draw_line(img1: QImage, pt1:QPoint, pt2:QPoint,task:str):
    if task == "down":
        ...
        # painter2: PyQt6.QtGui.QPainter = PyQt6.QtGui.QPainter(img2)
        # painter2.setPen(ie_globals.pen)
        # # set the brush of the painter
        # painter2.setBrush(ie_globals.brush)
        # painter2.setRenderHint(PyQt6.QtGui.QPainter.RenderHint.Antialiasing)
...
def draw_rect(img1: PyQt6.QtGui.QImage,  pt1:QPoint, pt2:QPoint,task:str):
    if task == "down":
        pass
    elif task == "move":

        painter = PyQt6.QtGui.QPainter(img1)
        print("drawing line")
        painter.setPen(ie_globals.pen)
        # set the brush of the painter
        painter.setBrush(ie_globals.brush)
    ...
    return None
def draw_round_rect(img1: PyQt6.QtGui.QImage,  pt1:QPoint, pt2:QPoint,task:str,corner_radius:int=10):
    if task == "move":
        painter= PyQt6.QtGui.QPainter(img1)
...
def draw_spray(img1: PyQt6.QtGui.QImage, pt1:QPoint,task:str):
    if task == "down":
        pass
    elif task == "move":
...
def select_wand(img1: PyQt6.QtGui.QImage, pt1: QPoint, task: str) -> None:
    """
    ...
    if task == "down":
        painter = PyQt6.QtGui.QPainter(img1)
        print("Wand")
        temp_pen = PyQt6.QtGui.QPen(QColor(255, 0, 0) ,1, PyQt6.QtCore.Qt.PenStyle.DotLine)
        ...
        painter.setPen(PyQt6.QtGui.QPen(PyQt6.QtGui.QColor(255, 0, 0), 3))
        ...
        pass
def fill(img1: PyQt6.QtGui.QImage, pt1: QPoint, task: str,tolerance:int=100) -> None:
    """
    ...
    if task == "down":
        ...
        temp_pen = ie_globals.pen ##dikkat
...
def erase(img1: PyQt6.QtGui.QImage, pt1: QPoint, task: str):
    return None