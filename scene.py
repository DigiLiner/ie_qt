...
from PySide6.QtGui import QPen, QColor, QBrush, Qt, QTransform, QPainter, QPixmap
...
class GraphicsScene(QGraphicsScene ):
    ...
    def convert(self, item: QGraphicsItem) -> QPixmap:
        ...
        pixmap.fill(PySide6.QtGui.QColor(255, 0, 0, 0))
    ...
    def mouseMoveEvent(self, event):
        ...
        if event.buttons() == PySide6.QtCore.Qt.MouseButton.LeftButton and self.drawing:  # `buttons()` instead of `button()`
            if  self.selected:
